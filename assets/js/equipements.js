document.addEventListener("DOMContentLoaded", async () => {
  try {
    ...
    for (const key in data) {
      ...
      btn.href = "#";
      btn.className = "button"; // ← retiré "small" pour utiliser le style standard
      btn.style.flex = "1 1 calc(33% - 1rem)"; // ← 3 par ligne
      ...
      popup.innerHTML = `
        <div class="popup-content" style="
          ...
          <h3 style="color:#222; font-size:1.4em; margin-bottom:1em;">${category.icon} ${category.label}</h3>
