...
;(function ($) {
  ...
  var settings = {
    ...
    excludeSelector:
      'input:focus, select:focus, textarea:focus, audio, video, iframe, #mobile-banner input, #mobile-banner textarea, #mobile-banner select',
      ...
      $window
        ...
        .on('keydown', function (event) {
          ...
          switch (event.keyCode) {
            ...
            // Page Down, Space.
            case 34:
              // case 32: // <-- supprimé pour désactiver le scroll avec la touche espace
              $document.scrollLeft(
                $document.scrollLeft() + $window.width() - 100
              )
              scrolled = true
